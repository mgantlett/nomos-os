...
function renderHeader(state) {
    ...
    if (hudPanel) {
        if (status && status.edition === 'community') {
            ...
            if (splitterBar)
                splitterBar.style.display = 'block';
        }
    }
    ...
    if (projectSelector) {
        if (status && status.edition === 'community') {
            ...
            projectSelector.onchange = (e) => {
                ...
                window.activeProjectFilter = val;
